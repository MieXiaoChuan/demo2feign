...
import com.example.demo2feign.controller.service.IFeignValueService;
...
public class FeignValueController {

    @Autowired
    IFeignValueService feignValueService;
    ...
    Result industryRisk () {
        ...
        Result result = feignValueService.industryRisk(param, body, authorization);
        return result;
    }
}
